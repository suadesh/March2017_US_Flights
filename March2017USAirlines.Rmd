...
Z <- ggplot(data = subset(flights,flights$CARRIER_DELAY >0), aes (x= CARRIER_DELAY))+
  geom_histogram(binwidth = 10, fill = 'darkred')+
  scale_x_continuous(limits = c(0,500), breaks = seq(0,500,50))+
  theme_minimal()

X <- ggplot(data = subset(flights,flights$WEATHER_DELAY >0), aes (x= WEATHER_DELAY))+
  geom_histogram(binwidth = 10, fill = 'orange')+
  scale_x_continuous(limits = c(0,500), breaks = seq(0,500,50))+
  theme_minimal()

Y <- ggplot(data = subset(flights,flights$NAS_DELAY >0), aes (x= NAS_DELAY))+
  geom_histogram(binwidth = 10, fill = 'navy')+
  scale_x_continuous(limits = c(0,500), breaks = seq(0,500,50))+
  theme_minimal()
  
W <-ggplot(data = subset(flights,flights$SECURITY_DELAY >0), aes (x= SECURITY_DELAY))+
  geom_histogram(binwidth = 10, fill = 'green')+
  scale_x_continuous(limits = c(0,500), breaks = seq(0,500,50))+
  theme_minimal()  

L <-ggplot(data = subset(flights,flights$LATE_AIRCRAFT_DELAY >0), aes (x= LATE_AIRCRAFT_DELAY))+
...
ggplot(data = flights, aes (x= CANCELLED ))+
  geom_histogram(stat = 'count',binwidth = 1)+
  theme_minimal() +
  scale_y_continuous(breaks = seq(0,500000,50000))

ggplot(data = subset(flights,flights$CANCELLED == 1 ), aes(x = CANCELLATION_CODE))+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggpairs(flights_sample, columns = c(1,3,22,24,27,30,37,39))
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, !is.na(ARR_DELAY)) , aes (x = ARR_DELAY, y = DEP_DELAY))+
...
ggplot(data = flights_sample , aes (y = ARR_DELAY, x=UNIQUE_CARRIER  ))+
  ...
  stat_summary(fun.y=mean, geom="point", shape=18, size=3, aes(color=UNIQUE_CARRIER))+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, flights_sample$ARR_DELAY_NEW >0 & flights_sample$DEP_DELAY_NEW >0)  , aes (x = ARR_DELAY_NEW, y = DEP_DELAY_NEW))+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, flights_sample$DEP_DELAY_NEW >0)  , aes (x = DEP_DELAY_NEW, y =TAXI_OUT  ))+
  geom_jitter(alpha = 1/20, color = 'black' )+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, flights_sample$ARR_DELAY_NEW >0)  , aes (x = ARR_DELAY_NEW, y =TAXI_OUT  ))+
  geom_jitter(alpha = 1/20, color = 'black' )+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, flights_sample$ARR_DELAY_NEW >0) , aes (y = ARR_DELAY_NEW, x=UNIQUE_CARRIER  ))+
  geom_boxplot(aes(color=UNIQUE_CARRIER))+
  stat_summary(fun.y=mean, geom="point", shape=18, size=5, aes(color=UNIQUE_CARRIER))+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, flights_sample$ARR_DELAY_NEW >0) , aes (y = ARR_DELAY_NEW, x= DAY_OF_WEEK  ))+
  geom_boxplot(aes(group = cut_width(DAY_OF_WEEK, 1)))+
  stat_summary(fun.y=mean, geom="point", shape=18, size=5)+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, flights_sample$ARR_DELAY_NEW >0)  , aes (y = ARR_DELAY_NEW, x=ORIGIN_STATE_NM  ))+
  geom_boxplot()+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = subset(flights_sample, flights_sample$ARR_DELAY_NEW >0)  , aes (y = ARR_DELAY_NEW, x=ORIGIN  ))+
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = flights_sample , aes (y = CARRIER_DELAY, x=UNIQUE_CARRIER))+
  geom_boxplot(aes(color=UNIQUE_CARRIER))+
  scale_y_continuous(limits = c(0,30))+
  scale_fill_ptol() +
  theme_minimal()

ggplot(data = flights_sample , aes (y = WEATHER_DELAY, x=UNIQUE_CARRIER))+
  geom_boxplot(aes(color=UNIQUE_CARRIER))+
  scale_y_continuous(limits = c(0,10))+
  scale_fill_ptol() +
  theme_minimal()

ggplot(data = flights_sample, aes (y = NAS_DELAY, x=UNIQUE_CARRIER))+
  geom_boxplot(aes(color=UNIQUE_CARRIER))+
  scale_y_continuous(limits = c(0,30))+
  scale_fill_ptol() +
  theme_minimal()

ggplot(data = flights_sample, aes (y = SECURITY_DELAY, x=UNIQUE_CARRIER))+
  geom_boxplot(aes(color=UNIQUE_CARRIER))+
  scale_y_continuous(limits = c(0,10))+
  scale_fill_ptol() +
  theme_minimal()

ggplot(data = flights_sample, aes (y = LATE_AIRCRAFT_DELAY, x=UNIQUE_CARRIER))+
  geom_boxplot(aes(color=UNIQUE_CARRIER))+
...
ggplot(data = flights_sample, aes (x=DAY_OF_WEEK))+
  geom_histogram(aes(color=UNIQUE_CARRIER))+
...
flights_by_origin <- group_by(subset(flights, !is.na(DEP_DELAY) & !is.na(TAXI_OUT) & !is.na(DEP_DELAY_NEW)), ORIGIN_CITY_NAME)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
flights_by_dest <- group_by(subset(flights, !is.na(ARR_DELAY) & !is.na(TAXI_IN) & !is.na(ARR_DELAY_NEW)), DEST_CITY_NAME)
...
ggplot()+ 
  ...
  geom_point( data=flights_by_dest_info, aes(x=lon, y=lat, size = n), color="DeepSkyBlue") + 
...
ggplot()+ 
  geom_polygon( data= subset(world, world$lat > -25 & world$long < -25 ), aes(x=long, y=lat, group = group),colour="white", fill="grey10" )+ 
  geom_point( data= flights_by_dest_info, aes(x=lon, y=lat, size = n), color="DeepSkyBlue" ) + scale_size(name="Destination")+
  theme_map()
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point( data=subset(flights_by_dest_info, flights_by_dest_info$lon > -130  & flights_by_dest_info$lat >20), aes(x=lon, y=lat, size = n), color="DeepSkyBlue") + 
  scale_size(name="Destination") +
  geom_abline(intercept =-48, slope = -0.9, linetype = 2, color = 'OrangeRed' , size = 3 , alpha = 1/3 )+
  geom_abline(intercept =-58, slope = -0.85, linetype = 2, color = 'OrangeRed' , size = 3 , alpha = 1/3 ) +
  theme_map()
```
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point(data=subset(flights_by_dest_info, flights_by_dest_info$lon > -130  & flights_by_dest_info$lat >20), aes(x=lon, y=lat, size = arr_delay_mean), color = 'Khaki') + 
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point(data=subset(flights_by_dest_info, flights_by_dest_info$lon > -130  & flights_by_dest_info$lat >20), aes(x=lon, y=lat, size = taxi_in_mean), color = 'Goldenrod') + 
...
world <- map_data("world")
ggplot()+ 
  geom_polygon( data= subset(world, world$lat > 15 & world$long < -50 ), aes(x=long, y=lat, group = group),colour="white", fill="grey10" )+ 
  geom_point( data= subset(flights_by_origin_info,flights_by_origin_info$lat >15), aes(x=lon, y=lat, size = n), color="DeepSkyBlue" ) + 
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point( data=subset(flights_by_origin_info, flights_by_origin_info$lon > -130  & flights_by_origin_info$lat >20), aes(x=lon, y=lat, size = n), color="DeepSkyBlue") + 
  scale_size(name="Origin") +
  theme_map()
```
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point(data=subset(flights_by_origin_info, flights_by_origin_info$lon > -130  & flights_by_origin_info$lat >20), aes(x=lon, y=lat, size = dep_delay_mean), color = 'Khaki') + 
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point(data=subset(flights_by_origin_info, flights_by_origin_info$lon > -130  & flights_by_origin_info$lat >20), aes(x=lon, y=lat, size = taxi_out_mean), color = 'Goldenrod') + 
...
ggpairs(flights_by_dest_info, columns = c(2,4,6,8,10))
ggpairs(flights_by_origin_info, columns = c(2,4,6,8,10))
```
...
cor.test(flights_by_origin_info$dep_delay_mean, flights_by_origin_info$taxi_out_mean)
...
ggplot(data = subset(flights_sample,flights_sample$ARR_DELAY>1), aes(y=ARR_DELAY, x= DEP_TIME))+
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point(data=subset(flights_by_origin_info, flights_by_origin_info$lon > -130  & flights_by_origin_info$lat >20), aes(x=lon, y=lat, size = dep_delay_mean, color = taxi_out_mean)) +
  scale_color_gradient(low = 'blue', high = 'red')+
  scale_size(name="Origin Delay departure") +
  theme_map()

cor.test(flights_by_origin_info$dep_delay_new_mean, flights_by_origin_info$taxi_out_mean)
```
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point(data=subset(flights_by_dest_info, flights_by_dest_info$lon > -130  & flights_by_dest_info$lat >20), aes(x=lon, y=lat, size = n,  colour = taxi_in_mean)) +
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) +
  geom_point(data=subset(flights_by_dest_info, flights_by_dest_info$lon > -130  & flights_by_dest_info$lat >20), aes(x=lon, y=lat, size = arr_delay_mean,  colour = taxi_out_mean)) +
  scale_colour_gradient(low="blue", high="red") +
...
ggplot(data = flights_sample, aes(DEST_STATE_NM,ORIGIN_STATE_NM)) + 
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
flights_by_tail <- group_by(subset(flights, !is.na(DEP_DELAY) & !is.na(DISTANCE) & !is.na(ARR_DELAY)), TAIL_NUM)
...
ggplot(data = flights, aes (y = ARR_DELAY, x=UNIQUE_CARRIER  ))+
  geom_boxplot(aes(color=UNIQUE_CARRIER))+
  stat_summary(fun.y=mean, geom="point", shape=18, size=4, aes(color=UNIQUE_CARRIER))+
  scale_y_continuous(limits = c(-60,60))+
  theme_minimal()+
  labs(x='',y='',
...
ggplot(data = flights_by_tail_info, aes(arr_delay_mean,n))+
  geom_jitter(aes(colour = distance_mean))+
  xlim(-25,100)+
  theme_minimal()+
  scale_color_gradient(low='PaleTurquoise', high='DarkMagenta',name='Distance Mean')+
  labs(x='Arriving Delay Mean',y='Numbers of flights',
...
ggplot() +
  geom_polygon( data=all_states, aes(x=long, y=lat, group = group),colour="white", fill="SlateGray" ) +
  geom_point(data=subset(flights_by_origin_info, flights_by_origin_info$lon > -130  & flights_by_origin_info$lat >20), aes(x=lon, y=lat, size = dep_delay_mean, color = taxi_out_mean)) +
  scale_color_gradient(low = 'navy', high = 'OrangeRed', name ='Taxi out mean')+
  scale_size(name="Origin Delay departure") +
  theme_map()+
